...
class HexletCodeTest < Minitest::Test
  ...
  def test_tag_generation
    ...
    assert_equal('<input type="text" class="user-input">', HexletCode::Tag.build("input", type: "text", class: "user-input"))
    ...
    assert_equal('<textarea name="job" rows="20" cols="40">hexlet</textarea>', HexletCode::Tag.build("textarea", name: "job", rows: 20, cols: 40) { "hexlet" })
  end
